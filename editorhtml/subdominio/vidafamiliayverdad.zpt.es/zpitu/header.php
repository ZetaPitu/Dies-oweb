...
<div id="cabecera" class="container ">
  ...
  <div style="text-align: center; background-color: rgba(68, 238, 204, 0.933);">
    <img src="https://ziw.es/subdominio/hhhhh.ziw.es/imagen/simple1.jpg" class="img-circle" alt="Bird" style="text-align: right; width: 40%; margin: 5px;"></div>
