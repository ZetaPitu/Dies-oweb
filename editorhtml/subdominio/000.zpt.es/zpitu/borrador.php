...
<!-- ZetaPitu -->
  ...
  <title>Mi banda</title><link id="estilos" href="https://ziw.es/subdominio/000.zpt.es/zpitu/css/banda.css" rel="stylesheet" type="text/css"><script id="script" src="https://ziw.es/subdominio/000.zpt.es/zpitu/js/banda.js"></script>
...
<div id="cabecera" class="container">
  <h3 class="margin" style="text-align: center;">¿Quieres a Juanito?</h3>
 ...
 <nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header ">
      ...
      <a class="navbar-brand" href="#myPage" style="text-align: right;">Juan</a><a class="navbar-brand" href="#myPage"><img src="https://ziw.es/subdominio/hhhhh.ziw.es/imagen/simple4.jpg" class="img-circle person" alt="Random Name" style="width:30%;margin:5px;"></a>
    </div>
    <div class="collapse navbar-collapse " id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#myPage" class="p-pulsado">Inicio</a></li>
        <li><a href="#band" class="">Banda</a></li>
...
">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item next left">
        <img src="https://ziw.es/images/tema1.jpg" alt="New York" style="width: 90%;margin: 5px;">
      ...
      <div class="item">
        <img src="https://ziw.es/images/tema4.jpg" alt="Chicago" style="/* width: 100%; */margin: 5px;">
        <div class="carousel-caption">
      ...
      <div class="item active left">
        <img src="https://ziw.es/images/tema5.jpg" alt="Los Angeles" style="/* width: 100%; */margin: 5px;">
        <div class="carousel-caption">
          <h3>ZetaPitu © 2020</h3>
...
<div id="band" class="container text-center">
  ...
  <p></p><div class="row">
    <div class="col-sm-4">
      ...
      <a href="#demo" data-toggle="collapse" aria-expanded="true">
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>Name</strong></p><br>
      <a href="#demo3" data-toggle="collapse" aria-expanded="true">
...
<div id="contact" class="container">
  ...
  <ul class="nav nav-tabs">
    <li><a data-toggle="tab" href="#home" aria-expanded="false">Juan</a></li>
    <li><a data-toggle="tab" href="#menu1" aria-expanded="false">Andres</a></li>
    <li class="active"><a data-toggle="tab" href="#menu2" aria-expanded="true">Pedro</a></li>
  </ul>
